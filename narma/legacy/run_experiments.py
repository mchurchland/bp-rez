...
from narma.legacy.experiment import ExperimentConfig, run_experiment
from narma.legacy.models import MODEL_NAMES


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description=__doc__)
    parser.add_argument("--output-dir", default="narma/results/narma10_300_nodes")
